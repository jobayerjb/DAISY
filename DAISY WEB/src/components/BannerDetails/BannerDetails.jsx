          ...
          <div className="grid grid-cols-1 items-center gap-4  md:grid-cols-2">
            ...
            >
              ...
              <div className="space-x-4">
                <button className="rounded-md border-2  bg-green px-4 py-2 text-lg  font-semibold bg-green-400 border-green-400 text-white transition-colors duration-300 hover:bg-green-600 hover:border-green-600">
                  Get Started
                </button>
              </div>
            </div>
